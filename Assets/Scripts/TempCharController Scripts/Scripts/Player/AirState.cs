...
public struct AirState : ICharacterState
{
    ...
    private bool ShouldWallJump(Vector2 input)
    {
        ...
        if (jumpCount > 0)
        {
            ...
            var horizontalRaycastOrigin = horizontalDirection == HorizontalDirection.Right ? raycastOrigins.BottomRight : raycastOrigins.BottomLeft;
    ...
    private bool HandleHorizontalMovement(Vector2 velocity, ref CharacterStateData characterStateData)
    {
    ...
    private void HandleVerticalMovement(bool didHitSide, float deltaTime, Vector2 velocity, ref CharacterStateData characterStateData)
    {
        ...
        var isWallSliding = verticalDirection == VerticalDirection.Down && didHitSide;
